...
pub const CREATE_INCREASE_POSITION_MARKET_REQUEST_DISCRIMINATOR: [u8; 8] = [184, 85, 199, 24, 105, 171, 156, 56];
...
impl CreateIncreasePositionMarketRequest {
  pub fn instruction(&self, args: CreateIncreasePositionMarketRequestInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CreateIncreasePositionMarketRequestInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
