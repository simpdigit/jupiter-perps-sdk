...
use crate::generated::types::IncreasePositionWithInternalSwapParams;
use borsh::BorshSerialize;
use borsh::BorshDeserialize;

pub const INCREASE_POSITION_WITH_INTERNAL_SWAP_DISCRIMINATOR: [u8; 8] = [114, 55, 106, 140, 199, 221, 32, 112];
...
impl IncreasePositionWithInternalSwap {
  pub fn instruction(&self, args: IncreasePositionWithInternalSwapInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: IncreasePositionWithInternalSwapInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&IncreasePositionWithInternalSwapInstructionData::new()).unwrap();
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct IncreasePositionWithInternalSwapInstructionArgs {
...
pub struct IncreasePositionWithInternalSwapBuilder {
            keeper: Option<solana_pubkey::Pubkey>,
                ...
                program: Option<solana_pubkey::Pubkey>,
                        params: Option<IncreasePositionWithInternalSwapParams>,
...
impl IncreasePositionWithInternalSwapBuilder {
  pub fn new() -> Self {
    ...
    pub fn program(&mut self, program: solana_pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn params(&mut self, params: IncreasePositionWithInternalSwapParams) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = IncreasePositionWithInternalSwap {
          ...
          let args = IncreasePositionWithInternalSwapInstructionArgs {
...
pub struct IncreasePositionWithInternalSwapCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: IncreasePositionWithInternalSwapInstructionArgs,
  }
  ...
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: IncreasePositionWithInternalSwapCpiAccounts<'a, 'b>,
              args: IncreasePositionWithInternalSwapInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
