...
use crate::generated::types::DecreasePositionWithInternalSwapParams;
use borsh::BorshSerialize;
use borsh::BorshDeserialize;

pub const DECREASE_POSITION_WITH_INTERNAL_SWAP_DISCRIMINATOR: [u8; 8] = [131, 17, 153, 110, 119, 100, 97, 38];
...
impl DecreasePositionWithInternalSwap {
  pub fn instruction(&self, args: DecreasePositionWithInternalSwapInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: DecreasePositionWithInternalSwapInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&DecreasePositionWithInternalSwapInstructionData::new()).unwrap();
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct DecreasePositionWithInternalSwapInstructionArgs {
...
pub struct DecreasePositionWithInternalSwapBuilder {
            keeper: Option<solana_pubkey::Pubkey>,
                ...
                program: Option<solana_pubkey::Pubkey>,
                        params: Option<DecreasePositionWithInternalSwapParams>,
...
impl DecreasePositionWithInternalSwapBuilder {
  pub fn new() -> Self {
    ...
    pub fn program(&mut self, program: solana_pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn params(&mut self, params: DecreasePositionWithInternalSwapParams) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = DecreasePositionWithInternalSwap {
          ...
          let args = DecreasePositionWithInternalSwapInstructionArgs {
...
pub struct DecreasePositionWithInternalSwapCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: DecreasePositionWithInternalSwapInstructionArgs,
  }
  ...
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: DecreasePositionWithInternalSwapCpiAccounts<'a, 'b>,
              args: DecreasePositionWithInternalSwapInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
