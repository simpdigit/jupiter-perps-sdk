...
use crate::generated::types::SetTestTimeParams;
...
impl SetTestTime {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: SetTestTimeInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
